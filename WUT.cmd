...
:permission
	...
	echo.    You are not running as Administrator = 1 Account.
	echo.    Win Update Tool requires elevation.
	echo.
	echo.    You need run this tool as 1 Account or contact Security Team .
	echo.
...
:terms
	...
	echo.	 
	echo.    Authorized for ESB and ESB Admin use ONLY. 
	echo.    
	echo.    You need to be Admin = 1 Account 
	echo.
	echo.    Batch files may flagg by anti-virus
	echo.    
	echo.    Aurther: Bilel Graine  
	echo.   
	echo.    11/01/2019
	echo.
	echo.    Copyright Bilel Graine
...
:: Run the Win Update Tool components.
:: void components();
:: /*************************************************************************************/
:components
